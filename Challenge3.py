...
class Game(Frame):
    ...
    def setupGUI(self):
        b1 = Button(self.master, text = "LED 8, 9", width = 12, relief = GROOVE, command = b1toggle)
        b1.grid(row = 1, column = 1)
        
        b2 = Button(self.master, text = "LED 8", width = 12, relief = GROOVE, command = led_8.toggle)
        b2.grid(row = 1, column = 2)

        b3 = Button(self.master, text = "LED 7, 8", width = 12, relief = GROOVE, command = b3toggle)
        b3.grid(row = 1, column = 3)

        b4 = Button(self.master, text = "LED 5", width = 12, relief = GROOVE, command = led_5.toggle)
        b4.grid(row = 2, column = 1)

        b5 = Button(self.master, text = "LED 6", width = 12, relief = GROOVE, command = led_6.toggle)
        b5.grid(row = 2, column = 2)

        b6 = Button(self.master, text = "LED 4", width = 12, relief = GROOVE, command = led_4.toggle)
        b6.grid(row = 2, column = 3)

        b7 = Button(self.master, text = "LED 7, 8", width = 12, relief = GROOVE, command = b3toggle)
        b7.grid(row = 3, column = 1)

        b8 = Button(self.master, text = "LED 2", width = 12, relief = GROOVE, command = led_2.toggle)
        b8.grid(row = 3, column = 2)

        b9 = Button(self.master, text = "LED 1, 2", width = 12, relief = GROOVE, command = b9toggle)
